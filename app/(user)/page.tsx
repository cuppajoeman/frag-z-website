  ...
  <div className="flex flex-col items-center justify-center w-full md:w-1/3">
    ...
    <ul className="h-44 md:h-60 md:mt-0 mt-3 text-sm p-3 text-justify border-b-white/90  border-r-white/90  border-l-2 border-t-2 border-b-2 border-t-black border-l-black border-r-2 bg-[#BEBEBE] md:text-lg overflow-y-scroll no-scrollbar">
      ...
      <li className="">
        ...
        projectile or sniper hits enemy while they&apos;re mid-air [above a
        certain height]
      </li>
      <li className="">
      ...
      <li className="">
        <span className="font-bold">Drop shot </span>
      ...
      <li className="">
        ...
        fire a projectile and it kills someone after a few seconds of travel
        time
      </li>
      <li className="">
...
const SupportInfo = () => (
  <div className="flex flex-col items-center justify-center w-full md:w-1/3">
    ...
    <div className="flex flex-row w-full justify-evenly items-center my-5">
      <a
        href="https://patreon.com/user?u=89056897"
        target="/"
      ...
      <a
        href="https://www.youtube.com/channel/UC85fkO9QnMYru6a2ZKPPK3g"
        target="/"
        className="text-4xl mx-auto"
      >
        <FaYoutube />
      ...
      <a
        href="https://www.instagram.com/frag.z.game/"
        target="/"
        className="text-4xl mx-auto"
      >
        <FaInstagram />
...
const cardData = [
  {
    ...
    video: (
      <VideoPlayer link="https://d21vt9tthjew1s.cloudfront.net/clip0.mp4" />
    ),
  },
  {
    title: "Principles",
    ...
    video: (
      <VideoPlayer link="https://d21vt9tthjew1s.cloudfront.net/clip1.mp4" />
    ),
  },
  {
        ...
        <div className="h-96 md:h-[450px] mb-5">
          ...
          <div className="flex flex-col items-center justify-center w-full h-full z-0">
            <video
              ...
              src="https://d21vt9tthjew1s.cloudfront.net/fragzGP0.mp4"
              poster="images/thumbnails/fragzGP0Thumbnail.jpg"
            />
          </div>
        </div>
